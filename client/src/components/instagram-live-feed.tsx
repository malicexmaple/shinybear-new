...
export default function InstagramLiveFeed() {
  ...
  return (
    <>
      ...
      `}</style>
      <section className="w-full bg-black relative flex items-center justify-center gentle-wobble" style={{ height: 'auto', minHeight: '400px', margin: '0', padding: '20px 0', width: '100vw', overflow: 'hidden' }} id="instagram">
        <div className="w-full px-4">
          {/* Contract Address Copy Box */}
          <div className="flex justify-center mb-4 relative" style={{ transform: 'translateY(200px)' }}>
